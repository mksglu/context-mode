import{createRequire as ce}from"node:module";import{existsSync as ue,unlinkSync as j,renameSync as de}from"node:fs";import{tmpdir as le}from"node:os";import{join as ge}from"node:path";var w=class{#e;constructor(e){this.#e=e}pragma(e){let r=this.#e.prepare(`PRAGMA ${e}`).all();if(!r||r.length===0)return;if(r.length>1)return r;let s=Object.values(r[0]);return s.length===1?s[0]:r[0]}exec(e){let t="",r=null;for(let a=0;a<e.length;a++){let i=e[a];if(r)t+=i,i===r&&(r=null);else if(i==="'"||i==='"')t+=i,r=i;else if(i===";"){let c=t.trim();c&&this.#e.prepare(c).run(),t=""}else t+=i}let s=t.trim();return s&&this.#e.prepare(s).run(),this}prepare(e){let t=this.#e.prepare(e);return{run:(...r)=>t.run(...r),get:(...r)=>{let s=t.get(...r);return s===null?void 0:s},all:(...r)=>t.all(...r),iterate:(...r)=>t.iterate(...r)}}transaction(e){return this.#e.transaction(e)}close(){this.#e.close()}},x=class{#e;constructor(e){this.#e=e}pragma(e){let r=this.#e.prepare(`PRAGMA ${e}`).all();if(!r||r.length===0)return;if(r.length>1)return r;let s=Object.values(r[0]);return s.length===1?s[0]:r[0]}exec(e){return this.#e.exec(e),this}prepare(e){let t=this.#e.prepare(e);return{run:(...r)=>t.run(...r),get:(...r)=>t.get(...r),all:(...r)=>t.all(...r),iterate:(...r)=>typeof t.iterate=="function"?t.iterate(...r):t.all(...r)[Symbol.iterator]()}}transaction(e){return(...t)=>{this.#e.exec("BEGIN");try{let r=e(...t);return this.#e.exec("COMMIT"),r}catch(r){throw this.#e.exec("ROLLBACK"),r}}}close(){this.#e.close()}},m=null;function Ee(n){let e=null;try{return e=new n(":memory:"),e.exec("CREATE VIRTUAL TABLE __fts5_probe USING fts5(x)"),!0}catch{return!1}finally{try{e?.close()}catch{}}}function me(n,e){let t=e!==void 0?e:globalThis.Bun;if(typeof t<"u"&&t!==null)return!0;let r=n??process.versions,[s,a]=(r.node??"0.0.0").split("."),i=Number(s),c=Number(a);return!Number.isFinite(i)||!Number.isFinite(c)?!1:i>22||i===22&&c>=5}function _e(){if(!m){let n=ce(import.meta.url);if(globalThis.Bun){let e=n(["bun","sqlite"].join(":")).Database;m=function(r,s){let a=new e(r,{readonly:s?.readonly,create:!0}),i=new w(a);return s?.timeout&&i.pragma(`busy_timeout = ${s.timeout}`),i}}else if(me()){let e=null;try{({DatabaseSync:e}=n(["node","sqlite"].join(":")))}catch{e=null}e&&Ee(e)?m=function(r,s){let a=new e(r,{readOnly:s?.readonly??!1}),i=new x(a);return s?.timeout&&i.pragma(`busy_timeout = ${s.timeout}`),i}:m=n("better-sqlite3")}else m=n("better-sqlite3")}return m}function pe(n){n.pragma("journal_mode = WAL"),n.pragma("synchronous = NORMAL");try{n.pragma("mmap_size = 268435456")}catch{}}function P(n,e,t={timeout:3e4}){let r;try{return r=new n(e,t),I(()=>pe(r)),r}catch(s){throw r&&f(r),s}}function B(n){if(!ue(n))for(let e of["-wal","-shm"])try{j(n+e)}catch{}}function ye(n){for(let e of["","-wal","-shm"])try{j(n+e)}catch{}}function f(n){try{n.pragma("wal_checkpoint(TRUNCATE)")}catch{}try{n.close()}catch{}}function V(n="context-mode"){return ge(le(),`${n}-${process.pid}.db`)}function I(n,e=[100,500,2e3]){let t;for(let r=0;r<=e.length;r++)try{return n()}catch(s){let a=s instanceof Error?s.message:String(s);if(!a.includes("SQLITE_BUSY")&&!a.includes("database is locked"))throw s;if(t=s instanceof Error?s:new Error(a),r<e.length){let i=e[r],c=Date.now();for(;Date.now()-c<i;);}}throw new Error(`SQLITE_BUSY: database is locked after ${e.length} retries. Original error: ${t?.message}`)}function Se(n){return n.includes("SQLITE_CORRUPT")||n.includes("SQLITE_NOTADB")||n.includes("database disk image is malformed")||n.includes("file is not a database")}function U(n){let e=n instanceof Error?n.message:String(n);return/duplicate column name|already exists/i.test(e)}function fe(n){let e=Date.now();for(let t of["","-wal","-shm"])try{de(n+t,`${n}${t}.corrupt-${e}`)}catch{}}var S=Symbol.for("__context_mode_live_dbs_v3__"),b=(()=>{let n=globalThis;return n[S]||(n[S]=new Set,process.on("exit",()=>{for(let e of n[S])f(e);n[S].clear()})),n[S]})(),D=class{#e;#t;constructor(e){let t=_e();this.#e=e,B(e);let r;try{try{r=P(t,e,{timeout:3e4})}catch(s){let a=s instanceof Error?s.message:String(s);if(!Se(a))throw s;fe(e),B(e);try{r=P(t,e,{timeout:3e4})}catch(i){throw new Error(`Failed to create fresh DB after renaming corrupt file: ${i instanceof Error?i.message:String(i)}`)}}this.#t=r,b.add(this.#t),I(()=>this.initSchema()),this.prepareStatements()}catch(s){throw r&&(b.delete(r),f(r)),s}}get db(){return this.#t}get dbPath(){return this.#e}close(){b.delete(this.#t),f(this.#t)}withRetry(e){return I(e)}cleanup(){b.delete(this.#t),f(this.#t),ye(this.#e)}};import{createHash as h}from"node:crypto";import{execFileSync as he}from"node:child_process";import{accessSync as Te,constants as ve,existsSync as C,mkdirSync as Re,realpathSync as be,renameSync as M}from"node:fs";import{homedir as Y}from"node:os";import{dirname as De,isAbsolute as K,join as g,resolve as p}from"node:path";var l="CONTEXT_MODE_DIR",z="sessions",H="content",T=class extends Error{kind;path;overrideEnvVar;ignoredEnvVar;ignoredReason;constructor(e,t,r=l,s,a,i={}){super(a??Ae(e,t,i),{cause:s}),this.name="StorageDirectoryError",this.kind=e,this.path=t,this.overrideEnvVar=r,this.ignoredEnvVar=i.ignoredEnvVar,this.ignoredReason=i.ignoredReason}},N=new Map;function Ke(n){let e=n.env??process.env,t=n.legacySessionDirEnv,r=t?e[t]?.trim():void 0;return r&&t?(n.onLegacySessionDir?.(t,r),r):g(Le(n.configDir,n.configDirEnv,e),"context-mode","sessions")}function Le(n,e,t){let r=e?t[e]:void 0;return r&&r.trim()!==""?W(r.trim()):W(n,Y())}function W(n,e){return n.startsWith("~")?p(Y(),n.replace(/^~[/\\]?/,"")):K(n)?p(n):e?p(e,n):p(n)}function Ne(n,e,t){return new T(n,e,l,void 0,[`Invalid ${l} for context-mode ${n} directory: ${t}`,ee()].join(`
`))}function Q(n){let e=process.env[l];if(e===void 0)return{kind:"unset"};let t=e.trim();if(!t)return{kind:"ignored-empty",ignoredEnvVar:l,ignoredReason:"empty"};if(!K(t))throw Ne(n,t,`${l} must be an absolute path.`);return{kind:"override",root:p(t)}}function Ce(n){return n.kind==="ignored-empty"?{ignoredEnvVar:n.ignoredEnvVar,ignoredReason:n.ignoredReason}:{}}function J(n,e){let t=Q(n);return t.kind!=="override"?null:{kind:n,path:g(t.root,e),envVar:l,source:"override"}}function Oe(n,e,t){return{kind:n,path:p(e()),envVar:null,source:"default",...t}}function Z(n){let e=Q("session");return e.kind==="override"?{kind:"session",path:g(e.root,z),envVar:l,source:"override"}:Oe("session",n,Ce(e))}function ze(n){let e=J("content",H);if(e)return e;let t=Z(n);return{kind:"content",path:g(De(t.path),H),envVar:t.envVar,source:t.source,ignoredEnvVar:t.ignoredEnvVar,ignoredReason:t.ignoredReason}}function Qe(n){let e=J("stats",z);if(e)return e;let t=Z(n);return{kind:"stats",path:t.path,envVar:t.envVar,source:t.source,ignoredEnvVar:t.ignoredEnvVar,ignoredReason:t.ignoredReason}}function Je(n){return n.message}function Ze(n){return n.source==="override"&&n.envVar?`via ${n.envVar}`:n.ignoredEnvVar&&n.ignoredReason==="empty"?`default; ignored empty ${n.ignoredEnvVar}`:"default"}function et(){N.clear()}function tt(n){let e=[n.kind,n.path,n.source,n.envVar??"",n.ignoredEnvVar??"",n.ignoredReason??""].join("\0"),t=N.get(e);if(t instanceof T)throw t;if(t===n.path)return t;try{return Re(n.path,{recursive:!0}),Te(n.path,ve.W_OK),N.set(e,n.path),n.path}catch(r){let s=new T(n.kind,xe(r)??n.path,l,r,void 0,{ignoredEnvVar:n.ignoredEnvVar,ignoredReason:n.ignoredReason});throw N.set(e,s),s}}function Ae(n,e,t={}){return[`context-mode ${n} directory is not writable: ${e}`,we(t),ee()].filter(Boolean).join(`
`)}function we(n){return n.ignoredEnvVar&&n.ignoredReason==="empty"?`Ignored empty ${n.ignoredEnvVar}; using adapter default.`:null}function ee(){return`Set ${l} to a writable absolute path.`}function xe(n){if(!n||typeof n!="object")return null;let e=n.path;return typeof e=="string"&&e.length>0?e:null}var _;function E(n){let e=n.replace(/\\/g,"/");return/^\/+$/.test(e)?"/":/^[A-Za-z]:\/+$/.test(e)?`${e.slice(0,2)}/`:e.replace(/\/+$/,"")}function X(n){let e=n;try{e=be.native(n)}catch{}let t=E(e);return process.platform==="win32"||process.platform==="darwin"?t.toLowerCase():t}function te(n,e){return he("git",["-C",n,...e],{encoding:"utf-8",timeout:2e3,stdio:["ignore","pipe","ignore"]}).trim()}function Ie(n){let e=te(n,["rev-parse","--show-toplevel"]);return e.length>0?E(e):null}function Ue(n){let e=te(n,["worktree","list","--porcelain"]).split(/\r?\n/).find(t=>t.startsWith("worktree "))?.replace("worktree ","")?.trim();return e?E(e):null}function Me(n=process.cwd()){let e=process.env.CONTEXT_MODE_SESSION_SUFFIX;if(_&&_.projectDir===n&&_.envSuffix===e)return _.suffix;let t="";if(e!==void 0)t=e?`__${e}`:"";else try{let r=Ie(n),s=Ue(n);if(r&&s){let a=X(r),i=X(s);a!==i&&(t=`__${h("sha256").update(a).digest("hex").slice(0,8)}`)}}catch{}return _={projectDir:n,envSuffix:e,suffix:t},t}function nt(){_=void 0}function ne(n){return h("sha256").update(E(n)).digest("hex").slice(0,16)}function re(n){let e=E(n),t=process.platform==="darwin"||process.platform==="win32"?e.toLowerCase():e;return h("sha256").update(t).digest("hex").slice(0,16)}function rt(n){let{projectDir:e,contentDir:t}=n,r=re(e),s=g(t,`${r}.db`);if(C(s))return s;let a=ne(e);if(a===r)return s;let i=g(t,`${a}.db`);if(C(i))try{M(i,s);for(let c of["-wal","-shm"])try{M(i+c,s+c)}catch{}}catch{}return s}function st(n){return Fe({...n,ext:".db"})}function Fe(n){let{projectDir:e,sessionsDir:t,ext:r}=n,s=n.suffix??Me(e),a=re(e),i=g(t,`${a}${s}${r}`);if(C(i))return i;let c=ne(e);if(c===a)return i;let d=g(t,`${c}${s}${r}`);if(C(d))try{M(d,i)}catch{}return i}var $=1e3,q=5;function L(n){let e=Number(n);return!Number.isFinite(e)||e<=0?0:Math.floor(e)}var o={insertEvent:"insertEvent",getEvents:"getEvents",getEventsByType:"getEventsByType",getEventsByPriority:"getEventsByPriority",getEventsByTypeAndPriority:"getEventsByTypeAndPriority",getEventCount:"getEventCount",getLatestAttributedProject:"getLatestAttributedProject",checkDuplicate:"checkDuplicate",evictLowestPriority:"evictLowestPriority",updateMetaLastEvent:"updateMetaLastEvent",ensureSession:"ensureSession",getSessionStats:"getSessionStats",getSessionRollup:"getSessionRollup",getMaxFileEdits:"getMaxFileEdits",getLatestCommitMessage:"getLatestCommitMessage",incrementCompactCount:"incrementCompactCount",getUsageCursor:"getUsageCursor",setUsageCursor:"setUsageCursor",upsertResume:"upsertResume",getResume:"getResume",markResumeConsumed:"markResumeConsumed",claimLatestUnconsumedResume:"claimLatestUnconsumedResume",deleteEvents:"deleteEvents",deleteMeta:"deleteMeta",deleteResume:"deleteResume",getOldSessions:"getOldSessions",searchEvents:"searchEvents",incrementToolCall:"incrementToolCall",getToolCallTotals:"getToolCallTotals",getToolCallByTool:"getToolCallByTool",getEventBytesSummary:"getEventBytesSummary"},ke=[["project_dir","TEXT NOT NULL DEFAULT ''"],["attribution_source","TEXT NOT NULL DEFAULT 'unknown'"],["attribution_confidence","REAL NOT NULL DEFAULT 0"],["bytes_avoided","INTEGER NOT NULL DEFAULT 0"],["bytes_returned","INTEGER NOT NULL DEFAULT 0"]];function se(n){let e=n.pragma("table_xinfo(session_events)"),t=new Set(e.map(s=>s.name)),r=!1;for(let[s,a]of ke)if(!t.has(s))try{n.exec(`ALTER TABLE session_events ADD COLUMN ${s} ${a}`),r=!0}catch(i){if(!U(i))throw i}return r&&n.exec("CREATE INDEX IF NOT EXISTS idx_session_events_project ON session_events(session_id, project_dir)"),r}function ot(n,e){let t=null;try{t=new e(n),se(t)}catch{}finally{try{t?.close()}catch{}}}var G=class extends D{constructor(e){super(e?.dbPath??V("session"))}stmt(e){return this.stmts.get(e)}initSchema(){this.db.transaction(()=>{let t=(this.db.pragma("table_xinfo(session_events)")??[]).find(r=>r.name==="data_hash");t&&t.hidden!==0&&this.db.exec("DROP TABLE session_events"),this.db.exec(`
